 ...
 * Use the [RegistrationCompletedFragment.newInstance] factory method to
...
class RegistrationCompletedFragment : Fragment(R.layout.fragment_registration_completed) {
    ...
    companion object {
         ...
         * @return A new instance of fragment RegistrationCompletedFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RegistrationCompletedFragment().apply {
